...
//     const handleTranslate=()=>{
//         fetch("https://translation.googleapis.com/language/translate/v2?key=AIzaSyCIDdYxT13driDencnt_2M5lGAoRmWA8DU", {
//         method: 'POST',
//         headers: {
//             "Content-Type": "application/json",
//             Accept: "application/json"
...
//             { q: props.extracted,
//               target: 'en',
//               key: 'AIzaSyCIDdYxT13driDencnt_2M5lGAoRmWA8DU'
//             }
//           )
//         })
//         .then(resp => resp.json())
//         .then(text => {
//             props.setTranslated(text.data.translations[0].translatedText)
//             navigation.navigate('NoteSubmitPage')
//         })
//     }
...
//           <Text>Title: {title}</Text>
//           <Text>Content: {content}</Text>
//           {/* <Text>Translated Content: {translated}</Text> */}
//         </ScrollView>
//       </View>
//     );
// }
